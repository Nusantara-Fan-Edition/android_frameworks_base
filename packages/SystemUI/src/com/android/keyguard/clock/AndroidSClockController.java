...
import com.android.keyguard.KeyguardSliceView.KeyguardSliceButton;
...
public class AndroidSClockController implements ClockPlugin {
    ...
    public void setSlice(Slice slice) {
        ...
        for (int i = startIndex; i < subItemsCount; i++) {
            ...
            if (icon != null) {
                final int iconSize = dpToPx(mContext, (((int) mSliceTextSize) - 4));
                ...
                mClock.animate()
                            .setUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                                ...
                                public void onAnimationUpdate(ValueAnimator animation) {
                                    mClock.setTextSize((float) dpToPx(mContext, (int) (mTextSizeNormal + (differenceSize * animation.getAnimatedFraction()))));
            ...
            if (mClockState) {
                mClock.animate()
                            .setUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                                @Override
                                public void onAnimationUpdate(ValueAnimator animation) {
                                    mClock.setTextSize((float) dpToPx(mContext, (int) (mTextSizeNormal + (differenceSize * (1f - animation.getAnimatedFraction())))));
                                    mClock.requestLayout();
                                }
                            })
                            .setDuration(550)
    ...
    public void setDarkAmount(float darkAmount) {
        ...
        for (int i = 0; i < mRow.getChildCount(); i++) {
            KeyguardSliceButton child = (KeyguardSliceButton) mRow.getChildAt(i);
